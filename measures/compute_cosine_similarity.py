...
if __name__ == '__main__':
    ...
    parser.add_argument('-in', '--folder-in', help = 'Folder to import files from', required = False)
    parser.add_argument('-out', '--measure-out', help = 'File used to save the measures', required = False)
